...
\setCJKfamilyfont{song}{SimSun.ttf}[Path=fonts/]

% 黑体 (SimHei)
\setCJKsansfont{SimHei.ttf}[Path=fonts/]
\setCJKfamilyfont{hei}{SimHei.ttf}[Path=fonts/]

% 楷体 (SimKai) —— 可选，但你既然传了就顺手绑上
\setCJKfamilyfont{kai}{SimKai.ttf}[Path=fonts/]

% ===== STXinwei (华文新魏) =====
\usepackage{fontspec}
\newfontfamily\Xinwei{STXINWEI.TTF}[Path=fonts/]
